...
use ownership_references::{bedazzle, change, eat, inspect};
...
fn main() {
    ...
    // Write a function `inspect` that takes a reference to a String, returns nothing, but
    ...
    // Write a function `change` that takes a *mutable* reference to a String and adds an "s" to
    ...
    // Write a function `eat` that accepts ownership of (consumes) a String and returns a bool
